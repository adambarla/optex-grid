...
\endtt
V nútri cyklu chem docieliť rozličné správanie pre každú desiatu čiaru pre lepšiu viditeľnosť pri používaní. Pridám teda ešte "\newcount\blockcount", ktorý tiež nastavím pred volaním vedľajšieho makra na nulu. Do predošlej podmienky vložím ešte jednu. Tá overuje či je "\linecount" násobok 10.
\begtt
...
\def\vertical {\noindent
  \ifnum\curr<\w
    ...
    \hbox to0pt{\hskip\left\hskip\curr\vbox to0pt{\vskip\top\noindent
      \ifnum\linecount =\temp
        \global\advance\blockcount1
        \newdimen\largerline \largerline=\h
        \advance\largerline\baselineskip
...
\def\horizontal {\noindent
  \ifnum\curr<\h
    ...
    \hbox to0pt{\hskip\left \vbox to0pt{\vskip\top\vskip\curr
      \ifnum\linecount =\temp
        \global\advance\blockcount1
        \newdimen\largerline \largerline=\w 
        \advance\largerline\baselineskip
